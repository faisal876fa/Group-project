...
export default function Site() {
  const {NHSNumber} = useParams();
    ...
    function handleSubmit(event) {
      ...
      navigate(`/TotalSeriesOfDoses/${NHSNumber}/${docID}/${dose}/${VaccinationDate}/${VaccineManufacturer}/${DiseaseTargeted}/${VaccineType}/${Product}/${VaccineBatchNumber}/${CountryOfVaccination}/${Authority}/${Site}`);
      }
    }
  ...
  return (
    <div>
        ...
        <div  className='table-medical-records'>
            ...
            <div id='error-box'>
              <H3>Site</H3>
              <div id="error-message-1">Site should not be empty</div>
