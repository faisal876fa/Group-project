...
export default function CountryOfVaccination() {
  const {NHSNumber} = useParams();
    ...
    const CountryOfVaccination = inputs.CountryOfVaccination;
    let navigate = useNavigate();

    function handleSubmit(event) {
      if(CountryOfVaccination=="") {
      ...
      navigate(`/Authority/${NHSNumber}/${docID}/${dose}/${VaccinationDate}/${VaccineManufacturer}/${DiseaseTargeted}/${VaccineType}/${Product}/${VaccineBatchNumber}/${CountryOfVaccination}`);
      }
    }
    ...
    <div>
        ...
        <div  className='table-medical-records'>
            <form onSubmit={handleSubmit}>
              ...
              <div>Country of vaccination</div></H5>
            </div>
            <div id='error-box'>
              <H3>Country of vaccination</H3>
              <div id="error-message-1">Country of vaccination should not be empty</div>
            <Input name='CountryOfVaccination' onChange={handleChange}/>
            </div>
            <div id='normal-box'>
            <H3>Country of vaccination</H3>
            <Input name='CountryOfVaccination' onChange={handleChange}/>
