...
export default function DisplayName() {
  const {NHSNumber} = useParams();
    ...
    function handleSubmit(event) {
      ...
      navigate(`/SnomedCode/${NHSNumber}/${docID}/${dose}/${VaccinationDate}/${VaccineManufacturer}/${DiseaseTargeted}/${VaccineType}/${Product}/${VaccineBatchNumber}/${CountryOfVaccination}/${Authority}/${Site}/${TotalSeriesOfDoses}/${DisplayName}`);
      }
    }
    ...
    <div>
        ...
        <div  className='table-medical-records'>
            <form onSubmit={handleSubmit}>
              ...
              <div>Display name</div></H5>
            </div>
            <div id='error-box'>
              <H3>Display name</H3>
              <div id="error-message-1">Display name should not be empty</div>
            <Input name='DisplayName' onChange={handleChange}/>
            </div>
            <div id='normal-box'>
           <H3>Display name</H3>
            <Input name='DisplayName' onChange={handleChange}/>
