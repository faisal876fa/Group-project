...
export default function DateEntered() {
    ...
    const DateEntered = inputs.DateEntered;
    ...
    function handleSubmit(event) {
      ...
      navigate(`/ProcedureCode/${NHSNumber}/${docID}/${dose}/${VaccinationDate}/${VaccineManufacturer}/${DiseaseTargeted}/${VaccineType}/${Product}/${VaccineBatchNumber}/${CountryOfVaccination}/${Authority}/${Site}/${TotalSeriesOfDoses}/${DisplayName}/${SnomedCode}/${DateEntered}`);
      }
    }
    ...
    <div>
        ...
        <div  className='table-medical-records'>
            <form onSubmit={handleSubmit}>
              ...
              <div>Date entered</div></H5>
            </div>
            <div id='error-box'>
              <H3>Date entered</H3>
              <div id="error-message-1">Date entered should not be empty</div>
            <Input name='DateEntered' onChange={handleChange} type='date'/>
            </div>
